<template>
	<b-modal id="confirmToDelete" content-class="border-0" centered hide-header no-close-on-backdrop no-close-on-esc footer-class="bg-light border-top-0">
